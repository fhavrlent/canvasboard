  ...
  ngOnInit() {
    this.data = [
      ...
      },
      {
        ...
        title: 'Chapter 3',
        subtitle:
          'Lorem ipsum dolor sit amet consecLorem ipsum dolor sit amet.tetur adipisicing eliteius.',
        id: 3,
        filters: ['one', 'two', 'three']
      },
      {
        imageURL:
          'https://i.pinimg.com/originals/db/64/a9/db64a98c70a688f6f509daf9c838be39.jpg',
        title: 'Chapter 4',
        subtitle:
          'LoremLorem ipsum dolor sit amet. ipsum dolor sit amet consectetur adipisicing eliteius.',
        id: 4,
        filters: ['one', 'two', 'three']
      },
      {
        imageURL:
          'https://miro.medium.com/max/1080/1*hU0QQDiOnsKpX4qlIyn_4w.jpeg',
        title: 'Chapter 5',
        subtitle:
          'Lorem ipsum dolor sit amet conseLorem ipsum dolor sit amet.ctetur adipisicing eliteius.',
        id: 5,
        filters: ['one', 'two', 'three']
      }
    ];
